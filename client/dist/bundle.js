...
function initNetworking() {
    net.connectTestSocket();
}
exports.initNetworking = initNetworking;
...
var SOCKETIO_CONNECTION_URL = '/socketio';
var NAMESPACES = {
    TEST: '/test'
};
function connectTestSocket(connURL, nsp) {
    if (connURL === void 0) { connURL = SOCKETIO_CONNECTION_URL; }
    if (nsp === void 0) { nsp = NAMESPACES.TEST; }
    var socket = io(nsp);
...
exports.connectTestSocket = connectTestSocket;
